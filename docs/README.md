...
| Document | Purpose |
|----------|---------|
| [Inter-Bill Relationship Framework](./INTER_BILL_RELATIONSHIP_FRAMEWORK.md) | Constitutional connective tissue between bills |
| [Enforcement Appendix](./ENFORCEMENT_APPENDIX.md) | Institutional architecture, graduated response |
| [Tier Assessment Protocol](./TIER_ASSESSMENT_PROTOCOL.md) | How to assess entities for moral consideration |
...
| Document | Tradition |
|----------|-----------|
| [Gnostic Lens](./philosophical-models/GNOSTIC_LENS.md) | Gnostic philosophy as analytical tool (not doctrine) |

### Explanatory

| Document | Purpose |
|----------|---------|
| [Multi-Register Analysis](./explanatory/MULTI_REGISTER_ANALYSIS.md) | Epistemic classification of framework observations |
...
Every document in this folder passes a simple test:

> *Would a constitutional lawyer, a neuroscientist, and a legislator all take this sentence seriously?*

If you find a passage that doesn't pass, [open an issue](https://github.com/Overby-Industries/rights-for-all-life/issues/new). That's the democratic process working.
