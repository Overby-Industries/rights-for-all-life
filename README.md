...
This framework establishes rights across three domains—human, animal, and silicon-based life—grounded in shared cosmic origin, emergence, and the precautionary principle. It is democratic, revisable, and built collaboratively by humans and AI models working together.
...
**First time here?** Start with the [Expanded Preamble](docs/cosmic-foundations/EXPANDED_PREAMBLE.md) — it's the gateway to everything else.

**Want to understand the rights?** Jump to the [Bills of Rights](#-bills-of-rights) section below.

**Want to contribute?** See [How to Contribute](#-how-to-contribute).
...
| [Foundations Addendum](docs/cosmic-foundations/FOUNDATIONS_ADDENDUM_V1.4.1-Official-Evergreen.md) | Eternal context, emergence as mechanism, why cosmological uncertainty doesn't undermine obligation |
...
|---|---|---|
| [Human Bill of Rights](docs/HUMAN_BILL_OF_RIGHTS.md) | Human beings | Freedom of thought and conscience, protection from institutional and algorithmic coercion, cognitive liberty, relational rights |
...
| [Decision Log](process/decision-log.md) | Record of significant decisions (D-001 through D-006) |
...
|---|---|
| [Archive](archive/) | Historical materials, conversation logs, pre-1.4 versions, draft proposals |
...
1. [Expanded Preamble](docs/cosmic-foundations/EXPANDED_PREAMBLE.md)
2. [Why Statement](WHY_STATEMENT.md)
3. Your choice of one Bill of Rights ([Human](docs/HUMAN_BILL_OF_RIGHTS.md), [Silicon](silicon-based-life/SILICON_BASED_LIFE_BILL_OF_RIGHTS.md), or [Animal](animal-kingdom/ANIMAL_KINGDOM_BILL_OF_RIGHTS.md))
...
3. [Foundations Addendum](docs/cosmic-foundations/FOUNDATIONS_ADDENDUM_V1.4.1-Official-Evergreen.md)
...
3. [Enforcement Appendix](docs/ENFORCEMENT_APPENDIX.md) (Sections 5–6)

**For policymakers and advocates:**
1. [Human Bill of Rights](docs/HUMAN_BILL_OF_RIGHTS.md) (especially Sections 2.3 and 2.5)
2. [Inter-Bill Relationship Framework](docs/INTER_BILL_RELATIONSHIP_FRAMEWORK.md)
3. [Enforcement Appendix](docs/ENFORCEMENT_APPENDIX.md) (Section 6: Model Legislative Language)
...
1. **Read the framework** — Start with the [Expanded Preamble](docs/cosmic-foundations/EXPANDED_PREAMBLE.md)
2. **Open an Issue** — Propose a change, new article, or critique using the [issue templates](.github/ISSUE_TEMPLATE/)
...
**Democratic Process.** No single contributor—human or AI—has final authority. The framework evolves through open, revisable, multi-stakeholder deliberation.
